 ...
 *
 * API: GET /api/clubs?limit=200  → { success, data: Club[], meta }
 *      Club.members[].userId     = raw ObjectId string in list (NOT populated)
 *
 * NOTE: No /api/clubs/mine endpoint exists yet — we fetch all clubs and
 * filter client-side. Add GET /api/clubs/mine on the backend when club
 * count grows to avoid over-fetching.
 */
