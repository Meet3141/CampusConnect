...
const TYPE_STYLES = {
  ...
  info: "border-slate-500/30 bg-slate-950/90 text-slate-100",
};
      ...
      {toasts.map((toast) => (
        ...
        >
          <div className="flex items-start gap-3">
            <div className="mt-0.5 text-[11px] font-semibold uppercase tracking-widest text-white/60">
              {TYPE_LABELS[toast.type]}
            </div>
            <div className="min-w-0 flex-1 text-sm leading-5 text-white/90">
              {toast.message}
            </div>
            <button
              type="button"
