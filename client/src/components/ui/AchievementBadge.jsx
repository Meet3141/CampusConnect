...
export const BADGE_DEFINITIONS = {
  club_member: {
    ...
    color:       "from-[var(--cc-color-brand)]/20 to-[var(--cc-color-brand)]/10",
    ring:        "ring-[var(--cc-color-brand)]/30",
    glow:        "shadow-[var(--cc-color-brand)]/20",
    iconColor:   "text-[var(--cc-color-brand)]",
  },
  event_attendee: {
    id:          "event_attendee",
  ...
  volunteer: {
    ...
    color:       "from-[var(--cc-color-success)]/20 to-[var(--cc-color-success)]/10",
    ring:        "ring-[var(--cc-color-success)]/30",
    glow:        "shadow-[var(--cc-color-success)]/20",
    iconColor:   "text-[var(--cc-color-success)]",
  },
  bookmarker: {
    id:          "bookmarker",
    label:       "Bookmarker",
    ...
    color:       "from-[var(--cc-color-warning)]/20 to-[var(--cc-color-warning)]/10",
    ring:        "ring-[var(--cc-color-warning)]/30",
    glow:        "shadow-[var(--cc-color-warning)]/20",
    iconColor:   "text-[var(--cc-color-warning)]",
  },
  social_butterfly: {
    id:          "social_butterfly",
    ...
    color:       "from-[var(--cc-color-danger)]/20 to-[var(--cc-color-danger)]/10",
    ring:        "ring-[var(--cc-color-danger)]/30",
    glow:        "shadow-[var(--cc-color-danger)]/20",
    iconColor:   "text-[var(--cc-color-danger)]",
  },
  early_adopter: {
    id:          "early_adopter",
    label:       "Early Adopter",
